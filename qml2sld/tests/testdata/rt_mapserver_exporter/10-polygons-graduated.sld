...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" units="mm" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>10-polygons-graduated</se:Name>
    <UserStyle>
      <se:Name>10-polygons-graduated</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name> 1.0000 - 1.8000 </se:Name>
          <se:Description>
            <se:Title> 1.0000 - 1.8000 </se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name> 1.8000 - 2.6000 </se:Name>
          <se:Description>
            <se:Title> 1.8000 - 2.6000 </se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name> 2.6000 - 3.4000 </se:Name>
          <se:Description>
            <se:Title> 2.6000 - 3.4000 </se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name> 3.4000 - 4.2000 </se:Name>
          <se:Description>
            <se:Title> 3.4000 - 4.2000 </se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name> 4.2000 - 5.0000 </se:Name>
          <se:Description>
            <se:Title> 4.2000 - 5.0000 </se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
