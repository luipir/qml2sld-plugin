...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="5" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 attr="ID" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="40" label="40"/>
      <category render="true" symbol="1" value="41" label="41"/>
      <category render="true" symbol="2" value="42" label="42"/>
      <category render="true" symbol="3" value="43" label="43"/>
      <category render="true" symbol="4" value="44" label="44"/>
    </categories>
    <symbols>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@2@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="255,238,0,255"/>
              <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="11,137,221,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="152,0,2,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
        ...
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@3@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="227,205,28,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="regular_star"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="169,12,138,255"/>
              <prop k="outline_style" v="solid"/>
              <prop k="outline_width" v="0"/>
              <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="outline_width_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="4">
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@4@1">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="163,141,0,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="2.6"/>
              <prop k="line_width_unit" v="MM"/>
              <prop k="offset" v="0"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MM"/>
          <symbol alpha="1" clip_to_extent="1" type="line" name="@4@2">
            <layer pass="0" class="SimpleLine" locked="0">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
